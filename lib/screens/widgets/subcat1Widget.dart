...
class Subcat1ListView extends StatelessWidget {
              ...
              return ListTile(
                ...
                subtitle: Row(
                  children: [
                    ...
                    Icon(
                      isSwipeIcon(items[index].isSwipe),
                      size: 17,
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => CustomizationPage(selectedCustomization: items[index].name,),
                    ),
                  );
                },
                shape: Border(
  ...
  IconData isSwipeIcon(bool isSwipe) {
    return isSwipe ? Icons.restaurant : Icons.no_meals;
  }
}
...
//                       debugPrint("Add button pressed! Adding ${items[index].name}");
//                       currentUser.cart.add(items[index]);
//                       Widget addAlertButton = TextButton(
//                         child: const Text("OK"),
//                         onPressed: () {
